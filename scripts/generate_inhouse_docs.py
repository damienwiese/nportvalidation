...
<div class="step"><h3>Step 2 - Run the preparation automation</h3><p><span class="label">Run:</span></p><div class="cmd">$p = ".\data\intake\2026-06\fdrs\positions.csv"
$o = ".\data\intake\2026-06\fdrs\create_redeem_orders.csv"
&amp; ".\.venv\Scripts\nport.exe" prepare FDRS 2026-06 --positions $p --orders $o</div><p><span class="label">System:</span> Creates <code>data/funds/fdrs/filings/2026-06/filing_inputs.xlsx</code>, calculates controls for the supplied files, and inserts Bloomberg formulas. Omit <code>--orders $o</code> when unavailable.</p><p><span class="label">Pass when:</span> The command prints the expected workbook path.</p></div>
